...
import 'career.dart';
import 'cuper_main.dart';
import 'growing.dart';
class cuper_prac extends StatefulWidget {
int index;
cuper_prac({this.index=0});

  @override
  _cuper_pracState createState() => _cuper_pracState();
}

class _cuper_pracState extends State<cuper_prac> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: isI(),
      endDrawer:  ff(super.context, widget.index),
      body: CupertinoTabScaffold(

        tabBar: CupertinoTabBar(
          items: [
          BottomNavigationBarItem(
              icon: Icon(CupertinoIcons.home), title: Text("1st")),
          BottomNavigationBarItem(

              icon: Icon(CupertinoIcons.search), title: Text("2nd")),
  ...
  static Drawer ff(context, int index) {
    switch (index) {
      case 1:
        return Drawer(
            child: ListView(
            ...
            child: ListView(
              ...
              children: [
                ...
                ListTile(
                  ...
                  onTap: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context) {
                      return wannajob("프로그래밍 언어를 사용하는 직무, 특히 소프트웨어 개발 분야를 희망합니다.",isi:1);
                    }));
                  },
                ),
                ListTile(
